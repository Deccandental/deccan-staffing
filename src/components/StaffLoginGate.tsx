...
const SESSION_KEY = "dd_leave_identity";

interface Props {
  children: (identity: StaffIdentity, logout: () => void) => ReactNode;
}

export default function StaffLoginGate({ children }: Props) {
  ...
  function persist(id: StaffIdentity) {
    setIdentity(id);
      ...
      <main className="min-h-screen" style={{ background: "#f5f5f5" }}>
        ...
        <div className="pt-16 lg:pt-0 lg:ml-64 flex items-center justify-center min-h-screen px-4">
          <div className="rounded-2xl bg-white p-6 sm:p-10 shadow-lg w-full max-w-sm text-center">
            ...
            <p className="text-gray-400 text-sm mb-8">Enter your personal PIN to submit or view your own leave requests. Managers can enter their passcode instead.</p>
            <input
              type="password"
              inputMode="numeric"
